...
A ready-to-use template for creating diagrams with [Excalidraw MCP](https://github.com/patchli/excalidraw-mcp-server) and Copilot CLI.

Ask Copilot to for example "create an architecture diagram" and it will research your codebase, build the diagram in Excalidraw, and export a PNG. Any kind of diagramming will be possible with this.
